    ...
    For Each produto_cor In referencias_produto_cor
        ...
        With ThisWorkbook.Sheets("BASE_GIRO")
            ...
            For Each tamanho In var_tamanhos
                ...
                svendas.Range("A5").AutoFilter Field:=21, Criteria1:=tamanho
                venda_tamanho = WorksheetFunction.Subtotal(9, svendas.Range("T:T"))
                estoque_tamanho = venda_tamanho + WorksheetFunction.SumIfs(sprodutos.Range("J:J"), sprodutos.Range("P:P"), produto_cor, sprodutos.Range("O:O"), tamanho)
