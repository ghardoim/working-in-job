...
Private Sub btn_adicionar_Click()
  ...
  With planilha.Sheets("ENTRADA")
    ...
    .Cells(ultLin_entrada, 8) = Me.txt_valor_pag.Value
    .Cells(ultLin_entrada, 9) = imposto
    .Cells(ultLin_entrada, 10) = Me.txt_valor_pag.Value - imposto
...
Private Sub btn_filtrar_Click()
  If Not eh_valido(Me.cbx_tipo) And Not eh_valido(Me.cbx_advogado) Then _
      Call msg_de_nao_preenchido("ADVOGADO OU TIPO"): Exit Sub
